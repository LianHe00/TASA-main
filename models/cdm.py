...
#         x = self.contact_model(x, pc_emb, text_emb, **kwargs) # [bs, num_points, last_dim]
...
#         self.contact_layer = nn.Linear(64, 1, bias=True)
